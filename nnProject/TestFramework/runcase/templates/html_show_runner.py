...
class HTMLTestRunner(Template_mixin):
    ...
    def run(self, test):
        ...
        show_result['startTime'] = self.startTime
        show_result['stopTime'] = self.stopTime
        return show_result
    ...
    def _generate_heading(self, report_attrs):
        ...
        for name, value in report_attrs:
            ...
            heading_info.update({saxutils.escape(name): saxutils.escape(value)})
            a_lines.append(line)
