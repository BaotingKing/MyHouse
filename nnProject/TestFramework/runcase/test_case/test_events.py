...
import unittest
from os import path
from ..models.runner import run_case
...
class TestEvents(unittest.TestCase):
    ...
    def test_OSK_Interface(self):
        ...
        self.assertEqual(True, True)
        # self.assertEqual(True, runcase.run_case())
...
class TestEventB(unittest.TestCase):
    ...
    def test_OSK(self):
        ...
        if ('failed' in case_name) or ('Failed' in case_name):
            self.assertEqual(run_case(case_path), False)
        else:
            self.assertEqual(run_case(case_path), True)
